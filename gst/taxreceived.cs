...
namespace gst
{
    public partial class taxreceived : Form
    {
        public taxreceived()
        {
            InitializeComponent();
        ...
        private void Add_Click(object sender, EventArgs e)
        {
            ...
            worksheet.Name = "Tax Received Sheet";
            ...
            saveFileDialoge.FileName = "Tax Received Report " + DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            printer.Title = "Tax Received Report ";
        ...
        private void taxreceived_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'gSTDataSet3.Inv_Tax' table. You can move, or remove it, as needed.
            this.inv_TaxTableAdapter.Fill(this.gSTDataSet3.Inv_Tax);
        ...
        private void textBox1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)13 && textBox1.Text != null)
            {
                ...
                {
                    con.Open();
                    string query = "SELECT  * FROM [Inv_Tax] where [" + comboBox6.Text + "] LIKE '%" + textBox1.Text + "%'";
            ...
            {
                con.Open();
                string query = "SELECT  * FROM [Inv_Tax]";
                using (SqlCeDataAdapter adapter = new SqlCeDataAdapter(query, con))
                {
                    DataSet ds1 = new DataSet();
                    adapter.Fill(ds1);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM Inv_Tax where Date_I BETWEEN '" + dateTimePicker1.Value.ToString() + " 'AND '" + dateTimePicker2.Value.ToString() + "'";
