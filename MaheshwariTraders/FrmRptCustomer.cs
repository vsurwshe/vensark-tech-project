...
namespace MaheshwariTraders
{
    public partial class FrmRptCustomer : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into Sales_View_Customer(Sales_OrderID,Distributor_Name,Sales_Date,Total_Products,Total_Quantity,Total,Paid,Remaining) select Sales_OrderID,Distributor_Name,Sales_Date,Total_Products,Total_Quantity,Total,Paid,Remaining from Sales where Distributor_Name='" + customername.Text + "'", con);
            cmd.ExecuteNonQuery();
